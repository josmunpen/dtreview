...
<form:form action="sponsor/edit.do" modelAttribute="sponsor">
	...
	<fieldset>
	<legend align="left"><spring:message code="sponsor.edit.contact" /></legend>
		...
		<form:label path="photoURL">
			<spring:message code="sponsor.edit.label.photoURL" />:
		</form:label>
	...
	<br/>
	<fieldset>
		<legend align="left"><spring:message code="sponsor.edit.userAcount" /></legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="sponsor.edit.label.password" />:
		</form:label>
	...
	<br/>
	<br/>
	<input type="submit" name="save" value="<spring:message code="sponsor.edit.save" />" />&nbsp;
