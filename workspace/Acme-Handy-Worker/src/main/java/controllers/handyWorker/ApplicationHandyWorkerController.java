...
public class ApplicationHandyWorkerController extends AbstractController {
	...
	@Autowired
	CustomisationService	customService;
	...
	public ModelAndView list() {
		...
		final Customisation custom;
		final List<Customisation> customList = new ArrayList<>(this.customService.findAll());
		final Integer VAT;

		custom = customList.get(0);
		VAT = custom.getVATPercentage();
