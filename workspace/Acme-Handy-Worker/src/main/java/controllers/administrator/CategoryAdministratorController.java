...
public class CategoryAdministratorController extends AbstractController {
	...
	public ModelAndView list() {
		...
		final List<Customisation> cusCol = (List<Customisation>) this.customisationService.findAll();
		final Customisation cus = cusCol.get(0);

		final String bannerURL = cus.getBannerURL();
	...
	protected ModelAndView createEditModelAndView(final Category category, final String message) {
		...
		parentCategoriesSinHijas.remove(category);
