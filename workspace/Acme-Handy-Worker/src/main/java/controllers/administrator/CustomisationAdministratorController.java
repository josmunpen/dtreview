...
public class CustomisationAdministratorController extends AbstractController {
	...
	public ModelAndView save(@Valid final Customisation customisation, final BindingResult binding, @RequestParam final String spamWords, @RequestParam final String cCM) {
		ModelAndView result;
		...
		if (binding.hasErrors())
			...
			try {
				...
				if (spamWords.contains(",")) {
					spamWithEmpty = spamWords.split("\\s*,\\s*");
